...
@MappedSuperclass // this will make sure this class will not be created as a table in the database.
@Getter
@Setter
public abstract class BaseModel {

    @Id // this annotation makes the id property a primary key of our table
    @GeneratedValue(strategy = GenerationType.IDENTITY) // identify means auto_increment
    protected Long id;
